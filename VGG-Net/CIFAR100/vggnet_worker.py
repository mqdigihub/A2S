...
tf.app.flags.DEFINE_integer('len', 19758436, """Number of parameters byte.""")


# Network Communication Configuration
tf.app.flags.DEFINE_integer('port', 2222, '''The port of parameter server''')
tf.app.flags.DEFINE_string('ip address', '10.1.2.95', '''The ip address of parameter server''')
    ...
    with tf.Session() as sess:
        ...
        while biased_acc > FLAGS.delta_acc:
            ...
            for worker_batch in worker_batches:
                ...
                grads = separate_grads_and_vars(grads_and_vars_list)  # 9881430
                com_start = time.time()
