...
def main():
    ...
    logit, loss, optimizer, grad_and_var = compute_cost(logits, Y, 0.0085, regularization)
    ...
    num_mini_batch = int(reshape_xs.shape[0] / 125)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(200):
            ...
            for mini_batch in mini_batches:
                ...
                # 聚类
                #
                paras = SGD_Optimizer(0.0085, paras, grads)
                com_start = time.time()
                com_end = time.time()
